...
public final class ADeclParaPassoDefinicaoComando extends PDefinicaoComando
{
    ...
    public ADeclParaPassoDefinicaoComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADeclParaPassoDefinicaoComando(
    ...
    {
        ((Analysis) sw).caseADeclParaPassoDefinicaoComando(this);
    }
