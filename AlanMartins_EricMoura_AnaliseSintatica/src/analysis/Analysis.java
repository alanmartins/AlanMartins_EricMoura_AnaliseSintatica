...
public interface Analysis extends Switch
{
    ...
    void caseAAtribuicaoExpLogicaDefinicaoComando(AAtribuicaoExpLogicaDefinicaoComando node);
    ...
    void caseAEscrevaExpLogicaDefinicaoComando(AEscrevaExpLogicaDefinicaoComando node);
    void caseADeclAvalieDefinicaoComando(ADeclAvalieDefinicaoComando node);
    void caseAAvalieExpLogicaDefinicaoComando(AAvalieExpLogicaDefinicaoComando node);
    ...
    void caseAExpAritMultiExp(AExpAritMultiExp node);
    void caseAExpressaoLogicaMultiExp(AExpressaoLogicaMultiExp node);
    void caseAMultiplaExp(AMultiplaExp node);
    void caseAMenosUnarioExp(AMenosUnarioExp node);
    ...
    void caseAExpOuLogica(AExpOuLogica node);
    void caseAItemOuLogica(AItemOuLogica node);
    void caseAExpXouItem(AExpXouItem node);
    void caseAItemXouItem(AItemXouItem node);
    void caseAExpELogTermo(AExpELogTermo node);
    void caseARelacioLogTermo(ARelacioLogTermo node);
    void caseAExpParLogTermo(AExpParLogTermo node);
    void caseARelacionalRelacional(ARelacionalRelacional node);
    void caseAIgualOperadores(AIgualOperadores node);
    void caseADiferenteOperadores(ADiferenteOperadores node);
    void caseAOperadores(AOperadores node);
    void caseAMenorOper(AMenorOper node);
    void caseAMaiorOper(AMaiorOper node);
    void caseAMenorIgualOper(AMenorIgualOper node);
    void caseAMaiorIgualOper(AMaiorIgualOper node);
