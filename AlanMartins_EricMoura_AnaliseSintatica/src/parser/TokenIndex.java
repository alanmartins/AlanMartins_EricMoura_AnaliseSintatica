...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTLColc(@SuppressWarnings("unused") TLColc node)
    {
        this.index = 11;
    }

    @Override
    public void caseTRColc(@SuppressWarnings("unused") TRColc node)
    {
        this.index = 12;
    }
    ...
    @Override
    public void caseTIgualLog(@SuppressWarnings("unused") TIgualLog node)
    {
        this.index = 19;
    }
